...
a <- dplyr::filter(NLrep1, pig == "29951", bin == "bins.1.fa", date == "2017-01-31")
a
b <- dplyr::filter(NLrep2, pig == "29951", bin == "bins.1.fa", date == "2017-01-31")
b
c <- dplyr::filter(no_reps, pig == "29951", bin == "bins.1.fa", date == "2017-01-31")
c
